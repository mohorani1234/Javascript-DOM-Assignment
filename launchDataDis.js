...
class InputData{
    constructor(
        ...
        this.bmpSensor_altitude = bmpSesnor_altitude;
...
function updateDisplay(){
    ...
    if(timeRead >= 10){
        ...
        document.getElementById("data").rows["gpsAltitude"].innerHTML = 
            dataRow("GPS Altitude", data[index].gpsAltitude, "meters");
        document.getElementById("data").rows["bmpSensorAlt"].innerHTML = 
            dataRow("BMP Altitude", data[index].bmpSensor_alt, "meters");
        document.getElementById("data").rows["bmpSensorPress"].innerHTML = 
            dataRow("BMP Pressure", data[index].bmpSensor_press, "barr");
        ...
        document.getElementById("data").rows["cssSensorTVOC"].innerHTML = 
            dataRow("CSS TVOC", data[index].cssSensor_eCO2, "ppm");
        document.getElementById("data").rows["UV"].innerHTML = 
            dataRow("UV", data[index].cssSensor_eCO2, "");
